...
public class Material
{
	 ...
	 */
	public Material(Color color, double ambientCoeff, double diffuseCoeff, double reflectiveCoeff, double specularCoeff, int shininess, boolean isTransparent, double indiceRef)
	{
		this.color = color;

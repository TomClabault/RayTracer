...
public class Material
{
	 ...
	 * @param isTransparent true pour que le matériau soit transparent, false sinon
	 * @param indiceRef Indice de réfraction de la lumière du matériau. Ignoré si le matériau n'est pas transparent
	 */
	public Material(Color color, double diffuseCoeff, double reflectiveCoeff, double specularCoeff, int shininess, boolean isTransparent, double indiceRef)
	{
		this.color = color;
	 ...
	 */
	public Material(Color color, double diffuseCoeff, double reflectiveCoeff, double specularCoeff, int shininess, boolean isTransparent, double indiceRef, ProceduralTexture proceduralTexture)
	{
		this.color = color;
		this.diffuseCoeff = diffuseCoeff;
		this.reflectiveCoeff = reflectiveCoeff;

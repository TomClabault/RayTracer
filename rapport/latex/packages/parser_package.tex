...
Pour parser notre fichier, nous avons besoin d'une classe servant en quelque sorte de chef d'orchestre.
...
Différentes classes héritent ensuite de cette classe mère afin de définir des catégories de matériau avec des propriétés fixées. Ces classes sont cependant devenues obsolètes avec la finition du parser qui ne peut constuire que des matériaux arbitraires.

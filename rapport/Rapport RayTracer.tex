...
\begin{figure}[h!]
	\adjustbox{center}{\includegraphics[width=0.75\textwidth]{img/rt/differentAmbient.png}}
...
\begin{figure}[h!]
	\adjustbox{center}{\includegraphics[width=0.85\textwidth]{img/rt/differentDiffuse.png}}
...
\begin{figure}[h!]
	\adjustbox{center}{\includegraphics[width=1.2\textwidth]{img/rt/differentSpecular.png}}
...
$I_A, I_D, I_S$ sont les intensités ambiante, diffuse et spéculaire présentées précédemment.

Pour la même sphère et la même source de lumière, nous obtenos alors:

\begin{figure}[h!]
	\adjustbox{center}{\includegraphics[width=\textwidth]{img/rt/phongAddition.png}}

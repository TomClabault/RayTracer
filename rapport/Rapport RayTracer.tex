...
\begin{figure}[h!]
	\adjustbox{center}{\includegraphics[width=1.4\textwidth]{img/rt/final/repCam2Rayonsv2.png}}
...
A l'issue de ces implémentations, nous obtenons alors l'image suivante (la scène est composée d'une sphère et d'un plan représentant le sol):

\begin{figure}[h!]
	\adjustbox{center}{\includegraphics[width=\textwidth]{img/rt/final/basicRender.png}}
\end{figure}
\FloatBarrier

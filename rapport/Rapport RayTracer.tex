...
\begin{figure}[h!]
	\adjustbox{center}{\includegraphics[width=0.90\textwidth]{diagrammes/classe_RayTracer.png}}
	
	\caption{Diagramme de la classe RayTracer}
	\label{diagrammeRayTracer}
\end{figure}
\FloatBarrier

Les sources de lumière et la caméra sont contenues dans la scène:

\begin{figure}[h!]
	\adjustbox{center}{\includegraphics[width=0.75\textwidth]{diagrammes/classe_RayTracingScene.png}}
...
Le package scene s'organise ainsi de la sorte:
